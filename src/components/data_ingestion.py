...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            data_path = os.path.join("src", "notebook", "healthcare.csv")
            df = pd.read_csv(data_path)
            logging.info("Dataset loaded and converted into dataframe")
            ...
            logging.info("Data ingestion initiated succcessfully")
